...
@InjectViewState
class FirstFragmentPresenter: MvpPresenter<FirstFragmentInterface>(), ConnectivityReceiver.ConnectivityRecieverListener {
        ...
        retrofit.create(RestApi::class.java).getData("bash", 50)
                ...
                .subscribeWith(object: Observer<List<ResponseModel>> {
                    ...
                    override fun onNext(t: List<ResponseModel>) {
                        (list as ArrayList<ResponseModel>).clear()
                        (list as ArrayList<ResponseModel>).addAll(t)
                        viewState.refreshOut()
                        viewState.updateLoading(false)
                    ...
                    override fun onError(e: Throwable) {
                        ...
                        viewState.showNetworkMessage(R.string.no_content)
                        viewState.updateLoading(false)
                        viewState.refreshOut()
                    }
                })
